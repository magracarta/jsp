...
<body>
	<%
		session.setAttribute("s_name1","저는 세션에 저장된 첫번째 값이에여. ^o^");
		session.setAttribute("s_name2","저는 세션에 저장된 두번째 값이에여. ^o^");
		session.setAttribute("s_name3","저는 세션에 저장된 세번째 값이에여. ^o^");
		
		out.print("<h3>-----세션값을 삭제하기 전 -------</h3>");
		String value = (String) session.getAttribute("s_name1");
		out.print("<h3>s_name1 : "+ value+"</h3>");
		value = (String) session.getAttribute("s_name2");
		out.print("<h3>s_name2 : "+ value+"</h3>");
		value = (String) session.getAttribute("s_name3");
		out.print("<h3>s_name3 : "+ value+"</h3>");
